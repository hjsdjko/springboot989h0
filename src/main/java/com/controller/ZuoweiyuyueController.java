...
public class ZuoweiyuyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZuoweiyuyueEntity zuoweiyuyue,
		...
		if(tableName.equals("shangjiashitang")) {
			zuoweiyuyue.setShitangmingcheng((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			zuoweiyuyue.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
