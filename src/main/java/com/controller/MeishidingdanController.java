...
public class MeishidingdanController {
    ...
    public R page(@RequestParam Map<String, Object> params,MeishidingdanEntity meishidingdan,
		...
		if(tableName.equals("shangjiashitang")) {
			meishidingdan.setShitangmingcheng((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
		...
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("shangjiashitang")) {
            ew.eq("shitangmingcheng", (String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
